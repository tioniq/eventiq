...
describe("is var", () => {
  ...
  it("should check generic type", () => {
    ...
    expect(
      isVariableOf(strVar, (v): v is string => typeof v === "string"),
    ).toBe(true)
    expect(
      isVariableOf(strVar, (v): v is number => typeof v === "number"),
    ).toBe(false)
    ...
    expect(
      isVariableOf(numVar, (v): v is number => typeof v === "number"),
    ).toBe(true)
    expect(
      isVariableOf(numVar, (v): v is string => typeof v === "string"),
    ).toBe(false)
    ...
    expect(
      isVariableOf(boolVar, (v): v is boolean => typeof v === "boolean"),
    ).toBe(true)
    expect(
      isVariableOf(boolVar, (v): v is string => typeof v === "string"),
    ).toBe(false)
